import type { Applicant, Job, DashboardStats } from '@/types';
...
export const mockJobs: Job[] = [
  {
    ...
    type: 'Full-time',
    description: 'We are seeking a Senior Backend Engineer to build scalable APIs and AI-powered services.',
    requirements: ['5+ years Node.js', 'REST/GraphQL APIs', 'MongoDB/PostgreSQL', 'Cloud (AWS/GCP)'],
  ...
  },
  {
    ...
    location: 'Remote',
    type: 'Full-time',
    description: 'Join our AI team to build intelligent screening and ranking models using Gemini.',
    requirements: ['Python proficiency', 'LLM experience', 'MLOps', 'Data pipelines'],
  ...
  },
  {
    ...
    type: 'Full-time',
    description: 'Build stunning, performant UIs for our recruitment platform using Next.js.',
    requirements: ['React/Next.js expertise', 'TypeScript', 'Tailwind CSS', 'State management'],
  ...
  },
  {
    ...
    type: 'Full-time',
    description: 'Design intuitive, accessible experiences for our AI recruitment platform.',
    requirements: ['Figma proficiency', 'Design systems', 'User research', 'Prototyping'],
    skills: ['Figma', 'Framer', 'User Research', 'Design Systems', 'Prototyping'],
    salaryMin: 3000,
    salaryMax: 5500,
    currency: 'USD',
    status: 'draft',
  ...
  },
  {
    ...
    location: 'Remote',
    type: 'Full-time',
    description: 'Build and maintain data pipelines for our analytics and AI training datasets.',
...
export const mockApplicants: Applicant[] = [
  {
    ...
    experience: [
      {
        ...
        startDate: '2022-03',
        endDate: 'Present',
        description: 'Led backend architecture for 3 enterprise clients, built real-time APIs serving 50k+ users.',
      ...
      },
      {
        ...
        startDate: '2020-01',
        endDate: '2022-02',
        description: 'Developed payment processing microservices handling $2M+ daily transactions.',
    ...
    certifications: [
      ...
      { name: 'MongoDB Professional', issuer: 'MongoDB Inc.', issueDate: '2022-03' },
    ],
    projects: [
      {
        name: 'AI Recruitment API',
        description: 'Built a REST API integrating Gemini for automated candidate screening',
    ...
    screening: {
      matchScore: 92,
      strengths: ['Deep Node.js expertise', 'Strong AWS experience', 'AI integration background', 'Proven at scale'],
      gaps: ['Limited Kubernetes production experience', 'No GraphQL at scale'],
      recommendation: 'Strongly Recommend',
      summary: 'Amara is an exceptional match for this role. Her 6 years of Node.js experience combined with AI integration work directly aligns with our requirements.',
      skillBreakdown: [
  ...
  },
  {
    ...
    status: 'screening',
    jobId: 'job-1',
    avatarUrl: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?w=100',
    skills: [
    ...
    experience: [
      {
        ...
        startDate: '2021-06',
        endDate: 'Present',
        description: 'Built merchant dashboard and payment APIs for 200k+ businesses.',
    ...
    screening: {
      matchScore: 78,
      strengths: ['Strong PostgreSQL skills', 'Payment systems experience', 'Full-stack capability'],
      gaps: ['Limited AWS experience', 'No AI/ML integration', 'Less backend specialization'],
      recommendation: 'Recommend',
      summary: 'Kwame brings solid full-stack experience but lacks the backend depth and AI integration experience the role demands.',
      skillBreakdown: [
  ...
  },
  {
    ...
    experience: [
      {
        ...
        startDate: '2021-09',
        endDate: 'Present',
        description: 'Built and deployed LLM-based applications for enterprise search and classification.',
    ...
    certifications: [
      { name: 'Google Cloud Professional ML Engineer', issuer: 'Google', issueDate: '2023-01' },
    ],
    projects: [],
    availability: { status: 'Open to Opportunities', type: 'Full-time', startDate: '2026-06-01' },
    socialLinks: { linkedin: 'https://linkedin.com/in/fatima-alhassan', github: 'https://github.com/fatimaalhassan' },
    screening: {
      matchScore: 96,
      strengths: ['Direct Gemini API experience', 'Google ML background', 'Strong Python mastery', 'MLOps knowledge'],
      gaps: ['Limited startup environment exposure'],
      recommendation: 'Strongly Recommend',
      summary: 'Fatima is an outstanding candidate with direct experience at Google on LLM systems. Her Gemini API expertise is exactly what we need.',
      skillBreakdown: [
  ...
  },
  {
    ...
    experience: [
      {
        ...
        startDate: '2022-01',
        endDate: 'Present',
        description: 'Led frontend team building investment platform for 500k+ users.',
    ...
    socialLinks: { github: 'https://github.com/chidinwosu', portfolio: 'https://chidi.dev' },
    screening: {
      matchScore: 89,
      strengths: ['Expert Next.js skills', 'Strong TypeScript', 'Design systems experience', 'Fintech background'],
      gaps: ['Limited testing coverage', 'No SSR optimization at scale'],
      recommendation: 'Strongly Recommend',
      summary: 'Chidi is a strong frontend candidate with proven experience building large-scale applications with the exact tech stack we use.',
      skillBreakdown: [
  ...
  },
  {
    ...
    screening: {
      ...
      gaps: ['Insufficient Kubernetes depth', 'No Terraform production experience', 'Limited cloud scale experience'],
      recommendation: 'Not Recommended',
      summary: 'Aisha shows potential but lacks the senior-level DevOps experience required for this role. We recommend revisiting in 18-24 months.',
      skillBreakdown: [
  ...
  },
  {
    ...
    experience: [
      {
        ...
        startDate: '2022-08',
        endDate: 'Present',
        description: 'Built microservices for mobile money platform serving West Africa.',
    ...
    screening: {
      matchScore: 71,
      strengths: ['Fintech microservices experience', 'Strong PostgreSQL', 'High-scale systems'],
      gaps: ['Primary language is Python not Node.js', 'Limited MongoDB experience', 'No AWS certification'],
      recommendation: 'Consider',
      summary: 'Emmanuel brings strong backend fundamentals but the tech stack mismatch (Python vs Node.js) is a concern for this specific role.',
      skillBreakdown: [
...
export const recentActivity = [
  { id: 1, type: 'screened', candidate: 'Amara Osei', job: 'Senior Backend Engineer', score: 92, time: '5m ago' },
  { id: 2, type: 'applied', candidate: 'Chidi Nwosu', job: 'Frontend Engineer', score: null, time: '23m ago' },
  { id: 3, type: 'shortlisted', candidate: 'Fatima Al-Hassan', job: 'AI/ML Engineer', score: 96, time: '1h ago' },
  { id: 4, type: 'screened', candidate: 'Emmanuel Diallo', job: 'Senior Backend Engineer', score: 71, time: '2h ago' },
  { id: 5, type: 'applied', candidate: 'Kwame Mensah', job: 'Senior Backend Engineer', score: null, time: '3h ago' },
];
